...
export default function Dashboard({ onLogout }) {
  ...
  const [user, setUser] = useState({
    ...
    nextAppointment: "oct 17, 2025 at 2:00 PM",
    totalSessions: 5,
    completedSessions: 2,
    upcomingSessions: 3
  });
  ...
  const doctors = [
    ...
    { 
      ...
      about: "Dr. Anita Patel is a specialist in women's health and reproductive medicine. She has helped hundreds of women with fertility issues, menstrual disorders, and pregnancy care using traditional Ayurvedic methods.",
        ...
        <Card className="border-0 bg-white/95 backdrop-blur-sm shadow-xl">
          ...
          <CardContent className="space-y-4">
            <div className="text-center">
              ...
              <Progress value={user.therapyProgress} className="h-3 w-full bg-emerald-100 [&>div]:bg-emerald-600" />
            </div>
